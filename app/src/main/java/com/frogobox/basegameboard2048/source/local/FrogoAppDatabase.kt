package  com.frogobox.basegameboard2048.source.local
...
import com.frogobox.basegameboard2048.util.helper.ConstHelper.RoomDatabase.ROOM_DATABASE_NAME
 ...
 *  com.frogobox.basegameboard2048.source.local
 *
 */
@Database(
    entities = [
